...
set(lcm_LibCMaker_DIRENT_SRC_DIR ${CMAKE_CURRENT_LIST_DIR})
# TODO: prevent multiply includes for CMAKE_MODULE_PATH
list(APPEND CMAKE_MODULE_PATH "${lcm_LibCMaker_DIRENT_SRC_DIR}/cmake/modules")


function(lib_cmaker_dirent)
  cmake_minimum_required(VERSION 3.2)

  cmr_print_message("======== Build library: Dirent ========")
  ...
  set(LIB_VARS
    COPY_DIRENT_CMAKE_BUILD_SCRIPTS
  )
  ...
  cmr_lib_cmaker(
    VERSION ${arg_VERSION}
    PROJECT_DIR ${lcm_LibCMaker_DIRENT_SRC_DIR}
